...
const App = () => {
    ...
    const handleAuthSubmit =data => {
      const user = {
        email: data.email,
        name: data.name || 'User',
        avtar:`https://ui-avatars.com/api/?name=${encodeURIComponent(data.name || 'User')}&background=random` 
      }
      setCurrentUser(user);
...
return (
      <Routes>
        ...
        />
        <Route element={currentUser ? <ProtectedLayout user={currentUser} onLogout={handleLogout} /> : <Navigate to="/login" replace />}>
