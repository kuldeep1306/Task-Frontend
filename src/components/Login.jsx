...
const Login = ({onSubmit, onSwitchMode}) => {
  ...
  return (
    <div className='max-w-md bg-white w-full shadow-lg border border-purple-100 rounded-xl p-8 '>
      ...
      <div className='w-16 h-16 bg-gradient-to-br from-fuchsia-500 to-purple-600 rounded-full mx-auto flex item-center justify-center mb-4'>
