...
import { CheckCircle, PlusCircle , Calendar , AlignLeft, Flag , Save, X  } from 'lucide-react';
...
const TaskModal = ({isOpen , onClose , taskToEdit , onSave,onLogout}) => {
  ...
  }, [taskData, getHeaders, today, onClose, onSave, onLogout])
      ...
      shadow-lg relative p-6 animate-fadeIn'>
        <div className='flex justify-between items-center mb-6'>
          ...
          <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <div>
              <label className='blocl text-sm font-medium text-gray-700 mb-1'>
                Task Title
              </label>
              <div className='block items-center border border-purple-100 rounded-lg px-3 py-2.5 
              focus-within:ring-2 focus-within:ring-purple-500 focus:focus-within:border-purple-500 transition-all duration-200'>
                  ...
                  <div className='flex gap-4'>
                    {[{ val:'yes' , label: 'Completed' }, { val:'no', label: 'In progress' }].map(({ val, label }) => (
                      <label key={val} className='flex items-center'>
                        ...
                        onChange={handleChange} className='w-4 h-4 text-purple-500' />
